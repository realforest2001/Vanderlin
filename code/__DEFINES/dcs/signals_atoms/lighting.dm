...
///Called right before the atom changes the value of light_falloff to a different one, from base [atom/proc/light_falloff]: (new_falloff)
#define COMSIG_ATOM_SET_LIGHT_FALLOFF "atom_set_light_falloff"
///Called right after the atom changes the value of light_falloff to a different one, from base [atom/proc/light_falloff]: (new_falloff)
#define COMSIG_ATOM_UPDATE_LIGHT_FALLOFF "atom_update_light_falloff"
