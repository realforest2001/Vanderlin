...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"Worshipper of the Ten Undivided" = TRAIT_TEN_UNDIVIDED,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_TEN_UNDIVIDED = "I haven't connected a divine patron. I wonder which one I should profess myself to...",
